...
interface ScrollRevealProps {
  ...
  // Added optional className property to resolve TS errors in components using it
  className?: string;
}

// Added className to the destructured props and passed it to the root motion.div
